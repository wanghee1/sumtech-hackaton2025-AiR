...
<br><br><br>
## 주요 기능
1. AI: AI 객체 인식 엔진이 도로 위의 모근 객체를 실시간으로 인식, 속도와 방향 예측, 충돌 위험 사전 계산
2. P2P 공유 네트워크: 위험 정보를 주변 차량에게 즉각 공유
3. HoloLens: P2P 네트워크를 통해 수집된 위험 요인을 3D AR로 직접 투영
<br><br><br>
## 부가 기능
1. TTS+STT: 음성으로 주변 장소 질문 후 음성 답변
<br><br><br>
## 실행
